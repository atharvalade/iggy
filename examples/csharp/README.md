...
The examples are automatically tested via `scripts/run-examples.sh --language csharp` to ensure they remain functional and up-to-date with the latest API changes.
