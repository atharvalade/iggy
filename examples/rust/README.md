...
The examples are automatically tested via `scripts/run-examples.sh --language rust` to ensure they remain functional and up-to-date with the latest API changes.
